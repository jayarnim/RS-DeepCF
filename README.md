# DeepCF: representation learning vs. matching function learning
...
- seminar date: 2024.02.22.

- paper review [`link`](https://jayarnim.github.io/posts/deepcf/)

- pkgs:
    - mlp based latent factor model experiment library [`link`](https://github.com/jayarnim/pkg-recsys-mlp)
